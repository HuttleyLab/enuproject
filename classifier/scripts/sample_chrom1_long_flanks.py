...
def main(resultdir, numprocs, test):
    ...
    commands = [make_command(sample, args_template, resultdir, fsz, fd, tsz)
                for fsz, fd, tsz in
                make_param_groups(flank_sizes=_flank_sizes, train_sizes=_train_sizes, feature_dims=_feature_dims)]
