...
def make_command(exec_cmnd, args_template, flank_size, feature_dim, train_size, sample_id, clf_nm):
    ...
    clf_path = "../results/chrom1/%d-mer/data_ratio_1/direction_All/%d_way_samples/train_size_%d/sample_%d/%s/nb_classifier.pkl" % (window_size, feature_dim, train_size, sample_id, clf_nm)
