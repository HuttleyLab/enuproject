...
def make_command(exec_cmnd, args_template, chrom, flank_size, feature_dim, clf_nm):
    ...
    clf_path = "../results/chrom1/%d-mer/data_ratio_1/direction_All/%d_way_samples/train_size_10255/sample_1/%s/logreg_classifier.pkl" % (window_size, feature_dim, clf_nm)
