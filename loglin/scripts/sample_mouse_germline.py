...
def get_var_data(aln, variant, ref_name, aln_flank, min_length, chroms):
    ...
    return (var_name, var_chrom, exon_strand, var_effects, allele_freqs, str(var_alleles), str(start_base), str(flank_5_seq), str(flank_3_seq), pep_alleles, gene_id, gene_loc)
